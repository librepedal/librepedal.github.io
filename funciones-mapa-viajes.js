...
function showNewTripForm(){ addedDests=[]; document.getElementById('trip-name').value=''; document.getElementById('trip-start').value=''; renderAddedDests(); filterDestType('hostel',document.querySelector('#v-newtrip .gtt')); cv('newtrip'); try{ if(typeof _mantencionAvisoPreViaje==='function') _mantencionAvisoPreViaje(); }catch(e){} try{ if(typeof _vehAvisoPreViaje==='function') _vehAvisoPreViaje(); }catch(e){} }
