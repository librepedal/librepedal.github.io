/* Libre Pedal — Efectos visuales de clima (prototipo listo para integrar)
   Ver COORDINACION-IA/SPEC-CLIMA-FX-2026-08-14.md antes de tocar esto: explica qué está
   validado por Inty, qué falta (enganchar a clima real), y cómo montarlo.
   ...
   Quien integre esto llama a climaFxSetMode() cuando cambie la condición de clima real
   (Open-Meteo) — ver el punto de enganche pendiente en el SPEC.
*/
(function(){
'use strict';
...
canvas.style.cssText='position:fixed;inset:0;width:100vw;height:100vh;z-index:5;pointer-events:none;';
