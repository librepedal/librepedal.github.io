...
3. **Sentry** (monitoreo de errores) — gratis hasta 5.000 errores/mes, se puede activar ya.
...
5. **Mapas y voz offline** — sin costo de servicio, es trabajo de código pendiente (crítico para cicloturismo en zonas sin señal).
