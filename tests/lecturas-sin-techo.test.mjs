...
const ARCHIVOS_JS = ['index.html', 'esfera.js', 'seguridad-sensores.js', 'clima-datos.js', 'voz-motor.js', 'reportes.js', 'rutas.js', 'mapa-render.js', 'auth.js', 'auth-vinculo.js', 'auth-sesion.js', 'gamificacion-darma.js', 'gamificacion-logros.js', 'gamificacion-ranking.js', 'gamificacion-retos.js', 'gamificacion-comunidad.js', 'novedades.js', 'social.js', 'segmentos.js', 'rodadas.js'];
